...
<div class="mt-5">
		<div class="d-flex ml-5" >			
			<button type="button" class="btn-secondary post-list-btn latelyBtn" data-sort-id="1">최신순 <i class="bi bi-arrow-repeat"></i> </button>
			<button type="button" class="beige-color post-list-btn black-color popularityBtn" data-sort-id="2">인기순 
