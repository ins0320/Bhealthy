...
### 📢 프로젝트 설명
* 대면/비대면 운동의 각각의 장점을 합친 서비스를 만들고 싶어 개발
* 필라테스 운동 센터 이용 고객을 대상으로 제공되는 서비스로, 월별 스케줄 공지, 커뮤니티, 공지사항 기능을 제공

### 👩‍🏫 포트폴리오
[포트폴리오](https://github.com/user-attachments/files/16559368/kimyoojung_portfolio.pdf)
